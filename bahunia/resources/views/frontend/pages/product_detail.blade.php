...
@endsection
@section('title','BAHUNIA || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">LKR.{{number_format($after_discount,2)}}</span><s>LKR.{{number_format($product_detail->price,2)}}</s> </p>
